...
Route::post('/jobs/filter', [JobsController::class, 'filter'])->name('jobs.filter');
...
Route::post('/partner', [OfficialController::class, 'partnerStore'])->name('partner.store');
Route::get('/manage/officials', [OfficialController::class, 'officialManagement'])->name('admin.official');
Route::get('/manage/partner', [OfficialController::class, 'partner'])->name('admin.partner');
